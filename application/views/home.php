			...
			<div class="row">
				...
				<div class="col-md-5">
					...
					<div class="row">			
						<div class="col-md-12">
							<div class="row">								
								<p class="text-center">Registrasi sudah ditutup. Pengumuman seleksi tugas akan diumumkan melalui dashboard masing-masing pendaftar pada tanggal 8 Februari 2016.</p>													

								<div class="col-md-4 col-md-offset-2 text-center ">					
									<a href="<?= site_url('info') ?>" class="btn btn-primary btn-lg center-block">More info</a>	
								</div>
								<div class="col-md-4 text-center ">
									<?php if ( ((time() < (strtotime('26th January 2016 19:00:00.0')-(21*60+30))) | (time() > (strtotime('6th February 2016 23:55:00.0')-(21*60+30)))) & !(time() > (strtotime('8th February 2016 19:30:00.0')-(21*60-30))) ): ?>
